...
const DailyNote: React.FC<DailyNoteProps> = ({ date }) => {
  const { dailyNote, updateNote, addTask, toggleTask, updateMood, saveNote } =
    useDailyNotes(date);
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Your daily thoughts and tasks
              </p>
            </div>
          </div>
          <br />
          <MoodSelector mood={dailyNote.mood} onMoodChange={updateMood} />
        </div>
